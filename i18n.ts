...
const resources = {
  en: {
    translation: {
      ...
      "scan_qr_instruction": "Scan this code to check-in the client.",
      ...
      "notification_body_zero": "has no sessions left in the {{packageName}} package.",
      "notification_body_one": "has 1 session left in the {{packageName}} package.",
      "notification_body_other": "has {{count}} sessions left in the {{packageName}} package.",
  ...
  ar: {
    translation: {
      ...
      "show_qr": "عرض QR",
      "qr_code_for": "رمز QR لـ",
      "scan_qr_instruction": "امسح هذا الرمز لتسجيل حضور العميل.",
